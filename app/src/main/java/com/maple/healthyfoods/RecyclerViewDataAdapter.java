...
public class RecyclerViewDataAdapter extends RecyclerView.Adapter<RecyclerViewDataAdapter.ItemRowHolder> {
    ...
    public void onBindViewHolder(ItemRowHolder holder, final int position) {
        ...
        holder.itemTitle.setText(sectionName);
        SectionListDataAdapter adapter = new SectionListDataAdapter(singleSectionItems, mContext,position);
       ...
       // snapHelper.attachToRecyclerView(holder.recyclerView);
        ...
        holder.itemTitle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(view.getContext(), "index More Clicked!" + dataList.get(position).getIndex(), Toast.LENGTH_SHORT).show();
            }
        });
    }
